...
from src.Auxiliary.EnumClasses import PhysicalDimensions, match_string
from src.Auxiliary.constants import EarthConstant_3 as GeoConstants
...
class ConvertSHCConfig:
    ...
    def set_Love_number(self, ln_k, ln_h, ln_l):
        self.ln_k = ln_k
        self.ln_h = ln_h
        self.ln_l = ln_l
        return self
...
class ConvertSHC:
    ...
    def _get_convert_array_to_dimensionless(self, field_type: PhysicalDimensions, lmax):
        ...
        return: [k1, k2, ..., kl, ...]
        """
        assert self.configuration.ln_k is not None
        ln = self.configuration.ln_k
    ...
    def __get_love_number_h_and_l(self, lmax=None):
        return self.configuration.ln_h[:(lmax+1)], self.configuration.ln_l[:(lmax+1)]
